...
## โหมดการใช้งาน (Chat Modes)

Kimi มีโหมดการใช้งานหลัก ๆ ให้เลือก 4 โหมด ตามลักษณะงานและความเร็วที่ต้องการ:

### 1. Instant ⚡
- **คำอธิบาย:** Fast chat, quick replies
- **เหมาะกับ:** การสนทนาแบบเร็ว ถาม-ตอบสั้น ๆ ที่ต้องการคำตอบฉับไว
- **จุดเด่น:** ความเร็วสูง ตอบกลับทันที

### 2. K3 🎯
- **คำอธิบาย:** Chat & Agent, flagship all-rounder
- **เหมาะกับ:** งานทั่วไปที่ต้องการทั้งการสนทนาและใช้ Agent ช่วยเหลือ
- **จุดเด่น:** เป็นโหมดหลัก (flagship) ที่ครอบคลุมความสามารถรอบด้าน

### 3. K3 Swarm 🐝
- **คำอธิบาย:** Massive search, batch processing, and more in one go
- **เหมาะกับ:** งานที่ต้องการค้นหาข้อมูลจำนวนมาก หรือประมวลผลหลายงานพร้อมกัน
- **จุดเด่น:** ค้นหาเชิงลึก ประมวลผลเป็นชุดใหญ่ในครั้งเดียว

### 4. K2.6 Agent 🛠️
- **คำอธิบาย:** Research, slides, websites, docs, sheets
- **เหมาะกับ:** งานที่ต้องการสร้างเอกสาร นำเสนอ เว็บไซต์ หรือวิเคราะห์ข้อมูล
- **จุดเด่น:** เน้นการทำงานเชิงสร้างสรรค์และวิชาการ
...
| โหมด | ใช้เมื่อไหร่ |
|------|-------------|
| **Instant** | ต้องการคำตอบเร็ว ๆ สนทนาทั่วไป |
| **K3** | งานทั่วไป ใช้ Agent ช่วยเหลือ |
| **K3 Swarm** | ค้นหาข้อมูลลึก ประมวลผลหลายงาน |
| **K2.6 Agent** | สร้างเอกสาร สไลด์ เว็บไซต์ วิเคราะห์ข้อมูล |
